...
use crate::{
    ...
    diagnostic::DiagnosticPlugin, environment::EnvironmentPlugin, movement::MovementPlugin,
    nateroid::Nateroid, schedule::SchedulePlugin, spaceship::SpaceshipPlugin, state::StatePlugin,
};
