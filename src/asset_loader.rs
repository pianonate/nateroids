...
fn cubemap_loaded(
    ...
    if !cubemap.is_loaded && asset_server.load_state(&cubemap.image_handle,) == LoadState::Loaded {
        ...
        // NOTE: PNGs do not have any metadata that could indicate they contain a
        // cubemap texture, so they appear as one texture. The following code
        // reconfigures the texture as necessary.
